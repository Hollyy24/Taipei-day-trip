...
class Booking:
    ...
    def add_booking_data(user_id, bookingdata):
        ...
        try:
            ...
            print("allready", allready_booking)
            if allready_booking:
            ...
            cursor.execute(insert_sql, (bookingdata.attractionId, bookingdata.date, bookingdata.time,
                           bookingdata.price, result["name"], result["address"], images_url[0], user_id,))
            cnx.commit()
            return "200"
